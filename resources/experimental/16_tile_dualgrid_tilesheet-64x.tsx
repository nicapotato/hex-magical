...
<tileset version="1.10" tiledversion="1.12.2" name="16_tile_dualgrid_tilesheet-64x" tilewidth="32" tileheight="32" tilecount="16" columns="4">
 <transformations hflip="1" vflip="1" rotate="1" preferuntransformed="0"/>
 <image source="../16_tile_dualgrid_tilesheet-64x.png" width="128" height="128"/>
 <wangsets>
  <wangset name="15tile-dualset" type="corner" tile="-1">
   ...
   <wangtile tileid="4" wangid="0,0,0,1,0,0,0,1"/>
   <wangtile tileid="5" wangid="0,1,0,1,0,1,0,0"/>
   ...
   <wangtile tileid="15" wangid="0,0,0,0,0,0,0,1"/>
  </wangset>
 </wangsets>
</tileset>
